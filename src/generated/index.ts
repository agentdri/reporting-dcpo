...
export * as DCPO_EVALUATION_PLAN_ACTION_CORRECTIFModel from './models/DCPO_EVALUATION_PLAN_ACTION_CORRECTIFModel';
export * as DCPO_EVALUATION_PLAN_CONTROLEModel from './models/DCPO_EVALUATION_PLAN_CONTROLEModel';
export * as DCPO_LISTE_ABSENCESModel from './models/DCPO_LISTE_ABSENCESModel';
...
export * from './services/DCPO_EVALUATION_PLAN_ACTION_CORRECTIFService';
export * from './services/DCPO_EVALUATION_PLAN_CONTROLEService';
export * from './services/DCPO_LISTE_ABSENCESService';
